  ...
  return (
    ...
    <div className="container">
        <div className="section-heading text-center mb-2-9 mb-lg-6 wow fadeIn" data-wow-delay="100ms">
            <span>Gallery</span>
            <h2 className="h1 mb-0">Financial Performance</h2>
            
        </div>
        <p className="mb-1-9   text-secondary lh34 ">
        New India Assurance Company is the largest non-life insurer in India. The financial strength of the Company is reflected from the following figures:-       </p>
